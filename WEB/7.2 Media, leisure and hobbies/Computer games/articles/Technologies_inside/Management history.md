...
· Любая кнопка — это просто выключатель, который замыкает контакт
· Современный геймпад — это маленький компьютер с процессором внутри
· Виброотдача — это два моторчика с грузиками
· Гироскоп чувствует повороты, акселерометр — наклоны
· Сигнал от кнопки до экрана проходит быстрее, чем ты моргаешь
